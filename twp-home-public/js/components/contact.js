...
function contact(scheme) {
    const b = BX.component(contact.wrap).align('center').left('50%').css('transform', 'translate(-50%, 0)');
    ...
    box().appendTo(b).size('90%', 450).html(mapTag).maxWidth(1200).marginBottom(40).border('1px solid white');
